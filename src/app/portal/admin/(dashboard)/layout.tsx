...
import { getAdminUser, clearAdminSession, setAdminSession, isAdminLoggedIn } from '@/lib/portal/admin/auth';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Nếu sessionStorage rỗng (vd: mở tab mới), gọi /api/auth/me để kiểm tra HttpOnly cookie
