...
import { submitRegistration, submitGroupRegistration, validateVoucherAction, type PopupConfig } from './actions';
...
export default function HomeClient({ initialPopupConfig }: { initialPopupConfig: PopupConfig | null }) {
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const updateTime = () => {
      ...
      const regDeadlineTarget = new Date('2026-07-25T08:00:00+07:00').getTime();
  ...
  return (
    <main className="overflow-x-hidden relative min-h-screen" style={{ backgroundImage: 'url(/backgoundTrangkhoahoc.jpg)', backgroundAttachment: 'fixed', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
              ...
              <div className="flex-1 overflow-y-auto scrollbar-none flex flex-col">
                ...
                {!isEarlyBirdExpired ? (
                  ...
                  <div className="px-5 py-5 flex flex-col items-center">
                    ...
                    {/* Đếm ngược nằm ở dưới */}
                    <p className="text-center text-sm font-black tracking-widest text-[#2563eb] uppercase mb-4">Đếm ngược</p>
      ...
      {/* Dynamic Promo Popup */}
      <PromoPopup initialConfig={initialPopupConfig} />
    </main>
  );
}
